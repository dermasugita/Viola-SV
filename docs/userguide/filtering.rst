...
---------------------------------------------
In the main PySgt object, including Vcf, Bedpe, and MultiBedpe, filtering-associated functions are eventually passed to the :doc:`filter_by_id<../reference/api/sgt.core.db.Vcf.filter_by_id>` method.
| :doc:`filter_by_id<../reference/api/sgt.core.db.Vcf.filter_by_id>` method receives a list of ID (SV ID or global ID) and return filtered object.
