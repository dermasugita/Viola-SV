...
impl ContigMeta {
    pub fn new(id: String, length: Option<i64>, assembly: Option<String>, url: Option<Url>, md5: Option<String>, species: Option<String>, taxonomy: Option<String>) -> Self {
        ContigMeta {
            id,
            length,
            assembly,
...
impl ContigMeta {
    ...
    pub fn from_hashmap(h: &HashMap<String, String>) -> Result<Self> {
        ...
        let length = h.get("length").map(|s| s.parse::<i64>().unwrap());
